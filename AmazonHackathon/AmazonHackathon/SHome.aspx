<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SHome.aspx.cs" Inherits="AmazonHackathon.SHome" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>IES-Student Home</title>
        ...
        <form runat="server">
            <div>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:Image ID="Image2" runat="server" Height="560px" Width="1345px" CssClass="img-responsive" />
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div>
            <div id="header">
            ...
            <div>
                <table id="image-table">
                    <tr>
                        <td id="td">
                            <a href="StudentExam.aspx">
                                <img src="Images/OnlineTest.jpg" /></a>
                        </td>
                        <td id="td1">
                            <a href="LetsGetCreative.aspx">
                                <img src="Images/LetsGetCreative.jpg" /></a>
                        </td>
                        <td id="td2">
